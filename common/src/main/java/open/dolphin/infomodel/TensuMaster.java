...
//masuda^   dataKbnを追加
    ...
    public String getYukoedymdStr() {
        return ("99999999".equals(yukoedymd)) ? "" : yukoedymd;
    }
    // 採用・非採用
...
//masuda$
    ...
    public String getSlot() {
        ...
        if (srycd.startsWith(ClaimConst.SYUGI_CODE_START)) {
            ...
            } else if (ClaimConst.YKZ_KBN_INJECTION.equals(ykzkbn)) {
                ret = ClaimConst.SLOT_TYUSHYA_YAKU;

            } else if (ClaimConst.YKZ_KBN_GAIYO.equals(ykzkbn)) {
