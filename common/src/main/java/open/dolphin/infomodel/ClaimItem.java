...
//masuda^ srysyuKbn, dataKbn追加
    private transient String srysyuKbn; // transient!!
    private transient String dataKbn;
    
    public void setSrysyuKbn(String syssyuKbn) {
        this.srysyuKbn = syssyuKbn;
    }
